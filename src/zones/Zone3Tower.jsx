...
export default function Zone3Tower() {
  return (
    <group position={ZONE3_OFFSET}>
      ...
      {/* ---- THE CASTLE / TOWER ---- */}
      <Prop path="/assets/building_castle_red.gltf" position={[0, 0, -14]} rotation={[0, Math.PI, 0]} scale={1.2} />
      ...
      <Prop path="/assets/mountain_B.gltf" position={[-14, 0, -10]} rotation={[0, 0.4, 0]} scale={1.6} />
      <Prop path="/assets/mountain_A.gltf" position={[14, 0, -12]}  rotation={[0, 2.8, 0]} scale={1.4} />
      <Prop path="/assets/mountain_B.gltf" position={[0, 0, -22]}   rotation={[0, 1.2, 0]} scale={2.0} />

      {/* Clouds — purple tinted for eerie feel */}
      <Prop path="/assets/cloud_big.gltf" position={[-8, 10, -12]} rotation={[0, 0.7, 0]} scale={1.2} physics={false} />
      <Prop path="/assets/cloud_big.gltf" position={[9, 12, -8]}   rotation={[0, 2.1, 0]} scale={0.9} physics={false} />
      <Prop path="/assets/cloud_big.gltf" position={[0, 14, -16]}  rotation={[0, 0.0, 0]} scale={1.4} physics={false} />
